"""
Interactive CLI for chatting with Llama Stack Agent with file operation tools.

Usage:
    python agent-cli.py chat
    python agent-cli.py chat --system-prompt "You are a coding assistant"
...
def chat(
    ...
    """
    Start an interactive chat session with a Llama Stack Agent.
    ...
    try:
        ...
        console.print(Panel.fit("[bold green]Llama Stack Agent[/bold green]", title="Initialized"))
